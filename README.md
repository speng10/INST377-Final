...
Regarding bugs, there is a slight issue with the players page not fetching and displaying the information of all 5 players on the graph. For example, sometimes only 4 out of 5 the players information will be displayed on the graph. We aim to fix this bug in a future update. 
