...
Regarding bugs, there is a slight issue with the players page displaying and fetching the names of all 5 players. For example, sometimes only 4 out of 5 the players information will be displayed on the graph. We aim to fix this bug in a future update. 
